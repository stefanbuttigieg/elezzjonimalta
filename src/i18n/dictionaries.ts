...
export const dictionaries: Record<Locale, Record<string, string>> = {
  en: {
    ...
    "faq.subtitle": "Common questions about voting in Malta's General Election. Each answer links back to its original source.",
    "faq.searchPlaceholder": "Search questions and answers…",
    "faq.empty": "No FAQs match your search.",
    "faq.viewSource": "View source page",
    "faq.source": "Source",
    "faq.disclaimer": "These FAQs are aggregated from third-party sources. We display them for convenience and link back to the original publisher. Always verify with the Electoral Commission for official guidance.",
    ...
    "candidate.audit.title": "Audit trail",
    "candidate.audit.subtitle": "Every source we used for this profile, grouped by type.",
    "candidate.audit.retrieved": "Retrieved",
    "candidate.audit.footnote":
      "We log each source so you can verify our facts. Spotted an error? Use the Contact page to flag it.",
    "candidate.audit.kind.official": "Official",
    "candidate.audit.kind.manifesto": "Manifesto",
    "candidate.audit.kind.news": "News",
    "candidate.audit.kind.social": "Social",
    "candidate.audit.kind.other": "Other",
    ...
    "common.electedInDistrict": "Elected — District {number}",
  ...
  mt: {
    ...
    "faq.subtitle": "Mistoqsijiet komuni dwar il-vot fl-Elezzjoni Ġenerali ta' Malta. Kull tweġiba tirreferi għas-sors oriġinali tagħha.",
    "faq.searchPlaceholder": "Fittex mistoqsijiet u tweġibiet…",
    "faq.empty": "L-ebda FAQ ma jaqbel mat-tiftix tiegħek.",
    "faq.viewSource": "Ara s-sors",
    "faq.source": "Sors",
    "faq.disclaimer": "Dawn il-FAQs huma miġbura minn sorsi terzi. Nuruhom għall-konvenjenza u nirreferu lejn il-pubblikatur oriġinali. Dejjem ivverifika mal-Kummissjoni Elettorali għal gwida uffiċjali.",
    ...
    "candidate.audit.title": "Reġistru tas-sorsi",
    "candidate.audit.subtitle": "Kull sors li użajna għal dan il-profil, miġbur skont it-tip.",
    "candidate.audit.retrieved": "Miġbur fi",
    "candidate.audit.footnote":
      "Inżommu rekord ta' kull sors biex tkun tista' tivverifika l-fatti tagħna. Sibt żball? Uża l-paġna ta' Kuntatt biex tinnotifikana.",
    "candidate.audit.kind.official": "Uffiċjali",
    "candidate.audit.kind.manifesto": "Manifest",
    "candidate.audit.kind.news": "Aħbarijiet",
    "candidate.audit.kind.social": "Soċjali",
    "candidate.audit.kind.other": "Oħrajn",
    ...
    "myDistrict.candidates.elected": "Elett/a",
    "myDistrict.electedHeading": "Eletti minn dan id-distrett",
